                    ...
                    <div>
                        <div className="lg:w-[570px]">
                            ...
                            <p className="text__para">
                                ...
                                Voluptate sequi, reprehenderit accusamus aut vitae odit beatae
                                sed expedita natus maiores alias sit placeat perferendis provident
                                autem veniam nesciunt. Dolorum, expedita.
                            </p>
                    ...
                    <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
                        ...
                        md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                            <div className="flex items-center justify-between ">
                                ...
                                <span className="w-5 h5 lg:w-[34px] lg:h-[34px] flex items-center justify-center

...
const About = () => {
    ...
    return <section>
        <div className='container'>
            <div className="flex justify-between gap-[50xp] lg:gap-[130px] xl:gap-0 flex-col lg:flex-row">
                { /* ====== about img ========*/}
                ...
                <div className='w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2'>
                    ...
                    <p className='text__para mt-[30px]'>
                        ...
                        patients-not looking back at what we accompished but towards what 
